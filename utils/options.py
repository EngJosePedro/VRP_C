...
def get_options(args=None):
    ...
    parser.add_argument('--T_train', type=int, default=50,
                        help='')
    ...
    parser.add_argument('--apply_gate_information', action='store_true', help='')
    parser.add_argument('--use_lora', action='store_true', help='')
    parser.add_argument('--swapopt', action='store_true', help='')
    parser.add_argument('--get_sequence', action='store_true', help='get_original sequence did by policy')
